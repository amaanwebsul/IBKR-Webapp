        ...
        <div className="flex-1">
          ...
          <main className="px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
            <section className="grid gap-6 xl:grid-cols-[minmax(0,1.45fr)_360px]">
              <div className="rounded-[32px] border border-white/10 bg-white/6 p-6 shadow-[0_30px_100px_rgba(8,15,33,0.42)] backdrop-blur-xl sm:p-8">
              ...
              <div className="rounded-[32px] border border-white/10 bg-slate-950/72 p-6 shadow-[0_24px_80px_rgba(15,23,42,0.24)] backdrop-blur-xl sm:p-7">
